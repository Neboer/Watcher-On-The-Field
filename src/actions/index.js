...
module.exports = {
    ...
    async maturation(target_wheat) {
        await bot.go(target_wheat.position, 2)
    ...
    async pile_bone_meal(composter, count) {
        await bot.go(composter.position, 2)
